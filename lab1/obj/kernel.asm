...
void interrupt_handler(struct trapframe *tf) {
    ...
    8020046a:	baa70713          	addi	a4,a4,-1110 # 80204010 <edata>
    8020046e:	631c                	ld	a5,0(a4)
                    if(num==10){
    80200470:	46a9                	li	a3,10
                    num++;//打印次数+1
    80200472:	0785                	addi	a5,a5,1
    80200474:	00004617          	auipc	a2,0x4
    80200478:	b8f63e23          	sd	a5,-1124(a2) # 80204010 <edata>
                    if(num==10){
    8020047c:	631c                	ld	a5,0(a4)
    8020047e:	fcd797e3          	bne	a5,a3,8020044c <interrupt_handler+0x86>
}
...
void exception_handler(struct trapframe *tf) {
    ...
    802004b8:	0141                	addi	sp,sp,16
            print_trapframe(tf);
    802004ba:	eabff06f          	j	80200364 <print_trapframe>
    802004be:	8082                	ret
    802004c0:	ea5ff06f          	j	80200364 <print_trapframe>
            cprintf("Exception type: Illegal instruction\n");
    802004c4:	00000517          	auipc	a0,0x0
    802004c8:	6f450513          	addi	a0,a0,1780 # 80200bb8 <etext+0x14e>
    802004cc:	ba1ff0ef          	jal	ra,8020006c <cprintf>
    ...
    802004f6:	70e50513          	addi	a0,a0,1806 # 80200c00 <etext+0x196>
    802004fa:	b73ff0ef          	jal	ra,8020006c <cprintf>
            cprintf("Illegal instruction caught at 0x%08x\n",tf->epc);
    802004fe:	10843583          	ld	a1,264(s0)
    80200502:	00000517          	auipc	a0,0x0
    80200506:	71e50513          	addi	a0,a0,1822 # 80200c20 <etext+0x1b6>
...
static inline void trap_dispatch(struct trapframe *tf) {
    ...
    80200528:	f63ff06f          	j	8020048a <exception_handler>
        interrupt_handler(tf);
    8020052c:	e9bff06f          	j	802003c6 <interrupt_handler>
